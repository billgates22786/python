...
class Regis:
    def __init__(self):
        ...
        self.f.place(x=418, y=132)
        
        self.l1 = Label(self.f, text="Anime World", font=("arial", 20, "bold"), fg="white", bg="black", borderwidth=5)
        self.l1.place(x=200, y=20)
        self.l2 = Label(self.f, text="Name", font=("arial", 15, "bold"), fg="#3be477", bg="black", borderwidth=5)
        self.l2.place(x=120, y=100)
        self.e2 = Entry(self.f, font=("arial", 15), fg="#3be477", bg="white")
